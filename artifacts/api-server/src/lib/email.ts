...
export async function sendWishlistDisclosureEmail({
  ...
  const body = `
    ...
    <p><strong>You are in control of this preference.</strong> If you would prefer that we not contact you about your wishlist or send you promotional emails, you can update this preference any time in your account settings -- it takes just a second.</p>
    ${buttonLink(accountSettingsUrl, "Manage Email Preferences")}
    ...
    <p style="font-size:15px;color:#666;">To manage your contact preferences, visit your <a href="${accountSettingsUrl}">account settings</a> at any time.</p>
  `;
