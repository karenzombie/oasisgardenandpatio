...
export default function AgentOrders() {
  ...
  return (
    <>
      <PageHeader title="My Orders" subtitle="Orders you have created or been assigned." />
      <PageBody>
        <form onSubmit={applyFilter} className="flex flex-wrap items-center gap-2 mb-4">
        ...
        {list.isLoading ? (
          ...
          <div className="flex flex-col items-center gap-2 py-16 text-slate-500">
            ...
            <Link href="/agent/new-order" className="text-blue-700 hover:underline">Create your first order</Link>
          </div>
        ) : (
          <>
                  ...
                  {rows.map((r) => (
                    <tr key={r.id} className="border-t hover:bg-slate-50">
                      <td className="px-3 py-2">
                        <Link href={`/agent/orders/${r.id}`} className="text-blue-700 hover:underline">
                          {r.orderNumber}
                        </Link>
                      </td>
                      <td className="px-3 py-2">
                      ...
                      <td className="px-3 py-2 capitalize">{formatStatusLabel(r.orderType)}</td>
                      <td className="px-3 py-2">
                      ...
                      <td className="px-3 py-2 text-right">{fmtMoney(r.balanceDue)}</td>
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-between mt-3 text-sm">
                ...
                <div className="flex gap-2">
                  ...
                  <Button type="button" variant="outline" size="sm" disabled={page + 1 >= totalPages}
